...
pub const MIXIN_PACKAGE: &str = "com.drunkness.mixin";
pub const MIXIN_PACKAGE_INTERNAL: &str = "com/drunkness/mixin";
pub const NATIVE_LOADER_INTERNAL: &str = "com/drunkness/runtime/NativeLoader";
...
// ("com_drunkness_runtime_NativePayloads").
pub const NATIVE_PAYLOADS_OWNER: &str = "com/drunkness/runtime/NativePayloads";
const MOD_ID: &str = "drunkness";
...
/// `UnsatisfiedLinkError`). A plain class outside the `com.drunkness.mixin`
/// package is invisible to the Mixin processor, so symbols stay bound to
/// `Java_com_drunkness_runtime_NativePayloads_<fn>` as the JNI spec expects.
