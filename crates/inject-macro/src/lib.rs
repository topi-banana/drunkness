...
// `com.drunkness.runtime.NativePayloads`. Keep this in sync with the builder-side
// `NATIVE_PAYLOADS_OWNER` ("com/drunkness/runtime/NativePayloads").
const JNI_NATIVE_OWNER: &str = "com_drunkness_runtime_NativePayloads";
...
mod tests {
    ...
    fn jni_escape_slash_and_dot_to_underscore() {
        assert_eq!(jni_escape("com/drunkness"), "com_drunkness");
        assert_eq!(jni_escape("com.drunkness"), "com_drunkness");
    }
